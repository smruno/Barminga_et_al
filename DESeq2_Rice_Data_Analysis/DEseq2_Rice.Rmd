...
raw.counts <- read.csv("Raw_Counts_Rice.csv")
...
exper_setup <- read.delim("Col_info_Rice.csv", sep = ",", check.names = F)
...
rice.samples <- c("IR1_S64_L001","IR1_S64_L002","IR2_S65_L001","IR2_S65_L002","IR3_S66_L001",
"IR3_S66_L002","IR4_S67_L001","IR4_S67_L002","IR5_S68_L001","IR5_S68_L002",
"IR6_S69_L001","IR6_S69_L002","IR7_S70_L001","IR7_S70_L002","IR8_S71_L001",
"IR8_S71_L002","IR9_S72_L001","IR9_S72_L002","RN1_S55_L001","RN1_S55_L002",
"RN2_S56_L001","RN2_S56_L002","RN3_S57_L001","RN3_S57_L002","RN4_S58_L001",
"RN4_S58_L002","RN5_S59_L001","RN5_S59_L002","RN6_S60_L001","RN6_S60_L002",
"RN7_S61_L001","RN7_S61_L002","RN8_S62_L001","RN8_S62_L002","RN9_S63_L001",
"RN9_S63_L002")
...
p.seqrep <- ggplot(prinComp, 
                   aes(x = PC1,
                       ...
                       shape = treatment)) + 
  geom_point(size = 3) +
  xlab("PC1 (86.25%)") + ## Check this values from head(get_eigenvalue(pcs))
  ylab("PC2 (2.64%)") +
...
## 1
res.e3 <- results(dds, contrast = c('variety', 'IR653DAI', 'IR65CTRL'))
...
## 2
res.e9 <- results(dds, contrast = c('variety', 'IR659DAI', 'IR65CTRL'))
...
## 1
res.l3 <- results(dds, contrast = c("variety","NIP3DAI","NIPCTRL"))
...
## 2
res.l9 <- results(dds, contrast = c("variety","NIP9DAI","NIPCTRL"))
...
svg("DESeq2_MA_plots_all_contrasts.svg", height = 20, width = 20)
...
saveWorkbook(wb, "DESeq_DGE_results.xlsx", overwrite = TRUE)
